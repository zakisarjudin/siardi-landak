...
<div id="browse-by-user-list-section" class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card mb-4">
        <div class="card-header d-flex flex-wrap justify-content-between">
            ...
            <a href="<?= base_url('user/browse-file/by-user'); ?>" class="btn rounded-pill btn-primary">
