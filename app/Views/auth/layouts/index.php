<!DOCTYPE html>
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="<?= base_url('template/sneat-1.0.0/'); ?>/assets/" data-template="vertical-menu-template-free">

<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />

    <title>Login Pages | Sistem Arsip Digital</title>

    <meta name="description" content="sistem arsip digital dinas kominfo landak" />
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?= base_url('template/sneat-1.0.0/'); ?>/assets/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
